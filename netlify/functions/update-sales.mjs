...
const ITEM_URL = "https://k.youshop10.com/QwNcydOY?a=b&p=iphone&wfr=BuyercopyURL&share_relation=5c57626beb7f72bb_1388062718_1"
...
export default async () => {
  ...
  if (items.length !== 4) throw new Error(`属性数量异常：预期 4，实际 ${items.length}`)
